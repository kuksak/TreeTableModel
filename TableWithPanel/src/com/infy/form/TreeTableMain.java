...
public class TreeTableMain extends JFrame {
     ...
     public static List<MyDataNode> list ;
    ...
    private static MyDataNode createDataStructure() {
        ...
        children1.add(new MyDataNode("Home Address1","some data","some data",null,null,null,null));
        children1.add(new MyDataNode("Home Address2","some data","some data",null,null,null,null));
        ...
        children2.add(new MyDataNode("Office Address1","some data","some data",null,null,null,null));
        children2.add(new MyDataNode("Office Address 2","some data","some data",null,null,null,null));
        ...
        rootNodes.add(new MyDataNode("Home", "some data", "some data", null,null,null, children1));
        rootNodes.add(new MyDataNode("Office", "some data", "some data", null,null,null, children2));
        list = children1;
 ...
 */
        MyDataNode root = new MyDataNode("Address", null, null, null,null,null, rootNodes);
        return root;
    }
